...
//   - Counter: The initial counter value for HOTP. Default is to use [Config.GenerateSecureRandomCounter]
...
//     for initialization (e.g, use [Config.GenerateSecureRandomCounter] to generate a
...
//     the server and the client side. Alternatively, use [Config.GenerateSecureRandomCounter] to generate a
...
//
//   - [CounterMismatchThreshold1x]: Adjust the synchronization window size if the counter mismatch exceeds 1.
//   - [CounterMismatchThreshold3x]: Adjust the synchronization window size if the counter mismatch exceeds 3.
//   - [CounterMismatchThreshold5x]: Adjust the synchronization window size if the counter mismatch exceeds 5.
//
